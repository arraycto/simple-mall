package com.yqf.mall.pms.config;
...
public class SwaggerConfiguration {
    ...
    public Docket restApi() {
        ...
        //密码模式
        String passwordTokenUrl="http://localhost:9999/yqf-auth/oauth/token";
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.yqf.mall.pms.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .termsOfServiceUrl("https://www.yqf.tech")
