...
import com.yqf.mall.pms.pojo.dto.admin.ProductFormDTO;
import com.yqf.mall.pms.pojo.entity.*;
import com.yqf.mall.pms.service.*;
...
public class PmsSpuServiceImpl extends ServiceImpl<PmsSpuMapper, PmsSpu> implements IPmsSpuService {
    ...
    public boolean add(ProductFormDTO productFormDTO) {
        ...
        bloomRedisService.addByBloomFilter(PmsConstants.PRODUCT_REDIS_BLOOM_FILTER, spu.getId() + "");
        return true;
    }
    ...
    @Override
    public com.yqf.mall.pms.pojo.dto.app.ProductFormDTO getProductByIdForApp(Long spuId) {
        // spu
        ...
        com.yqf.mall.pms.pojo.dto.app.ProductFormDTO product = new com.yqf.mall.pms.pojo.dto.app.ProductFormDTO(SpuDTO, attrs, specs, skuList);
        return product;
    }
}
