package com.yqf.admin.controller.v1;

import cn.hutool.core.convert.Convert;
import cn.hutool.core.util.StrUtil;
import com.yqf.admin.pojo.domain.LoginRecord;
import com.yqf.admin.service.ITokenService;
import com.yqf.common.base.BaseDocument;
import com.yqf.common.elasticsearch.service.ElasticSearchService;
import com.yqf.common.result.Result;
import com.yqf.common.web.util.IPUtils;
...
public class DashboardController {
    ...
    private long getTodayIpCount() {
        ...
        String indexName = "yqf-auth-login-" + date; //索引名称
    ...
    private long getTotalIpCount() {
        long totalIpCount = elasticSearchService.countDistinct(null, "clientIP.keyword", "yqf-auth-login-*");
        return totalIpCount;
    }
    ...
    public Result list(
        ...
        // 总记录数
        long count = elasticSearchService.count(queryBuilder, "yqf-auth-login-*");

        // 排序
        FieldSortBuilder sortBuilder = new FieldSortBuilder("@timestamp").order(SortOrder.DESC);

        // 分页查询
        List<LoginRecord> list = elasticSearchService.search(queryBuilder, sortBuilder, page, limit, LoginRecord.class, "yqf-auth-login-*");
